      ...
      <div className="hidden lg:flex flex-1 relative bg-white flex-col justify-between p-12 overflow-hidden border-r border-black/5">
        ...
        <div className="relative z-10 w-full">
          <Link href="/" className="flex items-center gap-3 w-fit group">
            ...
            <div className="font-headline text-2xl font-bold tracking-tight text-white drop-shadow-md">Cedar</div>
          </Link>
        </div>
        
        <div className="relative z-10 mb-10 max-w-lg bg-white/10 backdrop-blur-xl p-8 rounded-3xl border border-white/20">
          <div className="flex items-center gap-3 mb-4">
            <span className="material-symbols-outlined text-cedar-bronze" style={{ fontVariationSettings: "'FILL' 1" }}>auto_awesome</span>
            <span className="text-xs font-bold text-white uppercase tracking-widest">Auto-Curator Studio</span>
          </div>
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col pt-8 px-6 sm:px-12 md:px-24 justify-between bg-white overflow-y-auto">
        ...
        <div className="w-full flex justify-end hidden lg:flex">
          <div className="text-sm text-cedar-slate font-medium">
            Already have an account? <Link href="/login" className="font-bold text-cedar-forest hover:underline">Sign in</Link>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto my-auto py-8">
          <div className="mb-10 text-center lg:text-left">
            <span className="block text-xs uppercase tracking-[0.3em] text-cedar-bronze font-semibold mb-4">Join The Studio</span>
            <h1 className="font-headline text-4xl font-bold text-cedar-midnight mb-2">Create Account</h1>
            <p className="text-cedar-slate text-sm">Fill in your details to start curating your professional presence.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-xs font-bold text-cedar-midnight uppercase tracking-widest mb-2" htmlFor="name">Full Name</label>
              <input 
                id="name" 
                type="text" 
            ...
            <div>
              <label className="block text-xs font-bold text-cedar-midnight uppercase tracking-widest mb-2" htmlFor="password">Password</label>
            ...
            <div className="pt-6 text-center text-sm text-cedar-slate lg:hidden">
              ...
              <Link href="/login" className="ml-1 font-bold text-cedar-forest hover:underline">Sign in</Link>
            </div>
          </form>
        </div>
