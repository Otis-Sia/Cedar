      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col pt-8 px-6 sm:px-12 md:px-24 justify-between bg-white overflow-y-auto">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-12">
          <div className="mb-10 text-center lg:text-left">
            <span className="block text-xs uppercase tracking-[0.3em] text-cedar-bronze font-semibold mb-4">Welcome Back</span>
            <h1 className="font-headline text-4xl font-bold text-cedar-midnight mb-2">Sign in to Cedar</h1>
            <p className="text-cedar-slate text-sm">Curate your legacy. Access your dashboard and portfolios.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <label className="block text-xs font-bold text-cedar-midnight uppercase tracking-widest" htmlFor="password">Password</label>
                <Link href="/forgot-password" className="text-xs font-semibold text-cedar-forest hover:text-cedar-forest-dark transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
                <input 
                  ...
                  className="w-full p-4 rounded-xl border border-black/10 bg-cedar-alabaster/50 font-body text-base outline-none focus:border-cedar-bronze focus:ring-4 focus:ring-cedar-bronze/10 transition-all text-cedar-midnight" 
                />
                <button type="button" className="absolute right-4 top-1/2 -translate-y-1/2 text-cedar-slate hover:text-cedar-midnight focus:outline-none">
            ...
            <div className="flex items-center pt-2">
              <input id="remember" type="checkbox" className="w-4 h-4 rounded border-black/20 text-cedar-forest focus:ring-cedar-bronze/30 bg-cedar-alabaster" />
              <label htmlFor="remember" className="ml-2 text-sm text-cedar-slate">Keep me signed in</label>
            </div>
            ...
            <div className="pt-4">
              <button 
                ...
                className="w-full flex justify-center items-center gap-2 bg-cedar-forest text-white py-4 rounded-xl font-bold text-base shadow-[0_4px_20px_rgba(27,48,34,0.15)] hover:bg-cedar-forest-dark hover:-translate-y-0.5 disabled:opacity-70 disabled:translate-y-0 transition-all"
              >
                {isAuthenticating ? (
        ...
        <div className="pb-8 text-center lg:text-left text-xs font-medium text-cedar-slate">
          © 2026 Cedar. <Link href="/legal/privacy" className="hover:text-cedar-midnight">Privacy</Link> • <Link href="/legal/terms" className="hover:text-cedar-midnight">Terms</Link>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 relative bg-cedar-forest flex-col justify-between p-12 overflow-hidden border-l border-black/5">
        ...
        <div className="relative z-10 flex justify-end w-full">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10">
            <div className="w-1.5 h-1.5 rounded-full bg-cedar-bronze animate-[pulse_2s_infinite] shadow-[0_0_8px_#AA8C55]"></div>
            <span className="text-xs font-semibold text-white uppercase tracking-widest">Platform Operational</span>
          </div>
        </div>
        ...
        <div className="relative z-10 mb-10 max-w-lg">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-white/20 overflow-hidden backdrop-blur-sm">
              <Image width={40} height={40} className="object-cover grayscale" alt="portrait" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCz7R0o4_SwDScB_gU1LxAzSxZhpqjml-7YKu3L6IgONXpA4Bcq6I_aPRXl1eQyo0z6wCPJ8YChJLWycJPuaZjtDQz2tO8NgRQHry0R6Bpo9jjPrY3Ow8VaGiDWEOqYW_m_qy5kRQVHiMqszoaReVLVd37DyGMGtHQG1NClhd5O1mexvI6WfAS1eZoP0j95mvHR4VlkgWVuDuTiph2eCQPtwy8kSZxLwLU5_7IP42RszVL4bT8ogiBuBL47tPxRs-QVY-vmWgclv1hA"/>
            </div>
            <div>
              <p className="text-sm font-bold text-white">Sarah Jenkins</p>
              <p className="text-[10px] text-white/50 uppercase tracking-widest">Creative Director</p>
            </div>
          </div>
        </div>
      </div>
