  ...
  return (
    <>
      ...
      <header className="flex justify-between items-center px-8 md:px-12 py-10 shrink-0">
        <div>
          <h2 className="font-headline text-3xl md:text-4xl font-bold tracking-tight text-cedar-forest">Creative Hub</h2>
          <p className="text-sm text-cedar-slate mt-1 italic font-medium">Welcome back, Curator.</p>
        </div>
      ...
      {/* Dashboard Content */}
      <div className="px-8 md:px-12 pb-10 space-y-10 flex-1">
        
        {/* Bento Grid Layout */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Main Portfolio Summary (Bento 8x) */}
          <div className="md:col-span-8 bg-white rounded-3xl p-8 lg:p-10 flex flex-col justify-between min-h-[400px] border border-black/5 shadow-sm">
            <div className="flex justify-between items-start">
              <div>
                <span className="text-cedar-bronze uppercase tracking-[0.2em] font-bold text-[10px]">Active Ecosystem</span>
                <h3 className="font-headline text-3xl md:text-4xl text-cedar-midnight mt-2 font-bold leading-tight">Your Portfolios</h3>
              </div>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Portfolio Card 1 */}
              <div className="group relative bg-cedar-alabaster border border-black/5 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Link href="/dashboard/templates" className="bg-white text-cedar-forest p-2 rounded-lg shadow-sm hover:bg-cedar-forest hover:text-white transition-colors">
                    <span className="material-symbols-outlined text-sm">edit</span>
                  </Link>
                  <a href="#" className="bg-white text-cedar-forest p-2 rounded-lg shadow-sm hover:bg-cedar-forest hover:text-white transition-colors">
                ...
                <h4 className="text-cedar-midnight font-bold text-lg">Architectural Lines</h4>
                <p className="text-cedar-slate text-xs mt-1 font-medium">Updated 2h ago • 24 items</p>
                <div className="mt-5 flex items-center text-cedar-forest text-xs font-bold tracking-widest uppercase gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-cedar-forest animate-[pulse_2s_infinite]"></div>
                  Live
                </div>
              </div>
              ...
              <div className="group relative bg-cedar-alabaster border border-black/5 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                ...
                <div className="w-12 h-12 rounded-xl bg-white border border-black/5 flex items-center justify-center mb-5 text-cedar-slate">
                  <span className="material-symbols-outlined">palette</span>
                </div>
                <h4 className="text-cedar-midnight font-bold text-lg">Vibrant Canvas</h4>
                <p className="text-cedar-slate text-xs mt-1 font-medium">Updated 3 days ago • 12 items</p>
                <div className="mt-5 flex items-center text-cedar-slate text-xs font-bold tracking-widest uppercase gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-cedar-slate/50"></div>
                  Draft mode
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 flex justify-end">
              <Link className="text-cedar-forest font-bold text-sm flex items-center gap-2 group hover:text-cedar-forest-dark transition-colors" href="/dashboard/projects">
                View all projects 
            ...
            <div className="bg-white rounded-3xl p-8 flex-1 flex flex-col justify-between border border-black/5 shadow-sm relative overflow-hidden">
              ...
              <div className="mt-8 pt-6 border-t border-black/5 relative z-10">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-xs text-cedar-slate font-medium">Storage Used</span>
                  <span className="text-xs text-cedar-midnight font-bold">1.2 GB / 50 GB</span>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-5 bg-cedar-alabaster rounded-2xl group hover:bg-white hover:shadow-md border border-transparent hover:border-black/5 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-cedar-midnight font-bold text-sm">www.sarahvisuals.com</p>
                    <p className="text-cedar-slate text-xs mt-0.5">Primary Domain • Active</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-cedar-forest text-xs font-bold px-3 py-1 bg-white border border-cedar-forest/10 rounded-full shadow-sm">Secure</span>
              ...
              <div className="flex justify-between items-center p-5 bg-cedar-alabaster rounded-2xl group hover:bg-white hover:shadow-md border border-transparent hover:border-black/5 transition-all opacity-60 grayscale hover:grayscale-0 hover:opacity-100">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-white rounded-xl shadow-sm border border-black/5">
                    <span className="material-symbols-outlined text-cedar-bronze">dns</span>
                  </div>
                  <div>
                    <p className="text-cedar-midnight font-bold text-sm">portfolio.creative.studio</p>
                    <p className="text-cedar-slate text-xs mt-0.5">Propagating... (Estimated 2h)</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <button className="text-cedar-slate hover:text-cedar-midnight transition-colors">
        ...
        {/* Featured Showcase / Quick Insights */}
        <div className="bg-white rounded-3xl p-10 border border-black/5 shadow-sm relative overflow-hidden mt-6">
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 divide-y md:divide-y-0 md:divide-x divide-black/5">
            <div className="flex flex-col items-center text-center pt-4 md:pt-0">
              <span className="material-symbols-outlined text-[40px] text-cedar-forest mb-4">visibility</span>
              <h4 className="text-cedar-midnight font-headline font-bold text-4xl">4,281</h4>
              <p className="text-cedar-slate text-[10px] sm:text-xs uppercase font-semibold tracking-widest mt-2">Portfolio Views</p>
            </div>
            <div className="flex flex-col items-center text-center pt-8 md:pt-0">
              <span className="material-symbols-outlined text-[40px] text-cedar-bronze mb-4">auto_awesome</span>
              <h4 className="text-cedar-midnight font-headline font-bold text-4xl">18</h4>
              <p className="text-cedar-slate text-[10px] sm:text-xs uppercase font-semibold tracking-widest mt-2">Curated Edits</p>
            </div>
            <div className="flex flex-col items-center text-center pt-8 md:pt-0">
              <span className="material-symbols-outlined text-[40px] text-cedar-forest mb-4">trending_up</span>
              <h4 className="text-cedar-midnight font-headline font-bold text-4xl">12%</h4>
              <p className="text-cedar-slate text-[10px] sm:text-xs uppercase font-semibold tracking-widest mt-2">Conversion Lift</p>
            </div>
          </div>
        </div>
      </div>
